...
{    
    public class EnvironmentAssetAdministrationShell_V3_0 : EnvironmentIdentifiable_V3_0, IModelType
    {
        [JsonProperty("derivedFrom")]
        [XmlElement("derivedFrom")]
        public EnvironmentReference_V3_0 DerivedFrom { get; set; }

        [JsonProperty("assetInformation")]
        [XmlElement("assetInformation")]
        public EnvironmentAssetInformation_V3_0 AssetInformation { get; set; }

        [JsonProperty("submodels")]
        [XmlArray("submodels")]
        [XmlArrayItem("reference")]
        public List<EnvironmentReference_V3_0> SubmodelReferences { get; set; }

        [JsonProperty("views")]
        [XmlArray("views")]
        [XmlArrayItem("view")]
        public List<View_V3_0> Views { get; set; }

        [JsonProperty("conceptDictionaries")]
        [XmlArray("conceptDictionaries")]
        [XmlArrayItem("conceptDictionary")]
        public List<ConceptDictionary_V3_0> ConceptDictionaries { get; set; }
    ...
    public class ConceptDictionary_V3_0 : EnvironmentReferable_V3_0, IModelType
    {
        [JsonProperty("conceptDescriptions")]
        [XmlArray("conceptDescriptionRefs")]
        [XmlArrayItem("conceptDescriptionRef")]
        public List<EnvironmentReference_V3_0> ConceptDescriptionsRefs {get; set; }
    ...
    public class View_V3_0 : EnvironmentReferable_V3_0, IModelType
    {
        ...
        public List<EnvironmentReference_V3_0> ContainedElements { get; set; }
