...
{
    public class JsonValueListConverter_V3_0 : JsonConverter<List<ValueReferencePair>>
    {
        private static readonly ILogger logger = LoggingExtentions.CreateLogger<JsonValueListConverter_V3_0>();
